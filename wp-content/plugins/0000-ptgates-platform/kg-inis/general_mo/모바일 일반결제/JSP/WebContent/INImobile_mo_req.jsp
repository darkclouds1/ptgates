...
<%
	...
	String P_MID					= "INIpayTest";		                    	// 상점아이디					
	String P_AMT 					= "1000"; 									// 결제 금액
    String P_OID 					= P_MID +"_"+SignatureUtil.getTimestamp();	// 가맹점 주문번호(가맹점에서 직접 설정)
	String P_TIMESTAMP			    = SignatureUtil.getTimestamp();				// util에 의해서 자동생성
    String HashKey 					= "3CB8183A4BE283555ACC8363C0360223";   	// 모바일 금액위변조 Hash Key
