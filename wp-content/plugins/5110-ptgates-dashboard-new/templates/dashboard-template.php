...
// REST API 설정
$rest_url = get_rest_url(null, 'ptg-dash-new/v1/');
$nonce = wp_create_nonce('wp_rest');

// Study 페이지 URL 가져오기
$study_url = PTG_DashboardNew::get_study_url();
...
// 초기 렌더링 속도 최적화를 위해 PHP 단의 DB 조회 제거
// 데이터는 JS (AJAX)를 통해 비동기로 로드됨
$grade = 'basic'; 
$study_count = 0;
$quiz_count = 0;
$flashcard_count = 0;
...
<style>
    ...
    /* --- Skeleton UI Styles --- */
    .ptg-skeleton-wrapper {
        animation: ptg-fade-in 0.5s ease-out;
    }
    .ptg-skeleton {
    ...
    .ptg-skeleton::after {
        ...
        animation: ptg-shimmer 1.5s infinite;
    }
    
    @keyframes ptg-shimmer {
    ...
    /* --- End Skeleton UI Styles --- */
</style>

<div id="ptg-dashboard-new-app" class="ptg-dashboard-container">
    <!-- Skeleton UI (Initial State) -->
    <div class="ptg-skeleton-wrapper">
        <!-- Welcome Section Skeleton -->
        <div class="ptg-skeleton-welcome">
            <div class="ptg-skeleton ptg-skeleton-title" style="width: 30%;"></div>
            <div class="ptg-skeleton ptg-skeleton-text" style="width: 50%;"></div>
        </div>

        <!-- Stats Grid Skeleton -->
        <div class="ptg-dash-stats" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-bottom: 30px;">
            <div class="ptg-skeleton-card">
                <div class="ptg-skeleton ptg-skeleton-circle"></div>
                <div style="margin-top: auto;">
                    <div class="ptg-skeleton ptg-skeleton-text" style="width: 40%"></div>
                    <div class="ptg-skeleton ptg-skeleton-title" style="width: 70%; margin-bottom: 0;"></div>
                </div>
            </div>
            <div class="ptg-skeleton-card">
                <div class="ptg-skeleton ptg-skeleton-circle"></div>
        ...
        <div class="ptg-skeleton-content">
             <div style="padding: 24px;">
                 <div class="ptg-skeleton ptg-skeleton-title" style="width: 20%; margin-bottom: 24px;"></div>
                 <div class="ptg-skeleton ptg-skeleton-text" style="width: 100%; margin-bottom: 12px; height: 40px;"></div>
                 <div class="ptg-skeleton ptg-skeleton-text" style="width: 100%; margin-bottom: 12px; height: 40px;"></div>
                 <div class="ptg-skeleton ptg-skeleton-text" style="width: 100%; margin-bottom: 12px; height: 40px;"></div>
             </div>
        </div>
