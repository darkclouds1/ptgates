<?php 
/**
 * Account Form Template (WP Kakao Login Kit)
 */
...
?>
        ...
        <?php if ( $active_tab === 'profile' ) : ?>
            <form method="post" class="ptg-form">
                <?php wp_nonce_field( 'wpklk_profile_action', 'wpklk_profile_nonce' ); ?>
                ...
                <div class="ptg-input-group">
                    <input type="text" name="display_name" value="<?php echo esc_attr( $user->display_name ); ?>" class="ptg-input" placeholder="이름" required>
                </div>

                <div class="ptg-input-group">
                    <input type="email" value="<?php echo esc_attr( $user->user_email ); ?>" class="ptg-input" disabled style="background:#f5f5f5;" title="이메일 변경은 지원하지 않습니다.">
                </div>
